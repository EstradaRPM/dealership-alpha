...
const styles = StyleSheet.create({
  ...
  muted: { fontFamily: 'monospace', fontSize: 12, color: colors.borderMuted },
  dismiss: {
    marginTop: 16,
    paddingVertical: 12,
    borderRadius: 6,
  ...
  dismissPrimary: { backgroundColor: colors.primary },
  dismissText: {
    fontFamily: 'monospace',
    fontSize: 13,
    color: colors.textMuted,
  ...
  dismissTextPrimary: { color: colors.base, fontWeight: '700' },
});
